import { mode, toggleTheme } from '@/store/reducers/theme-slice';
...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    margin: 1,
    padding: 0,
    transform: 'translateX(4px) translateY(5%)',
    '&.Mui-checked': {
...
const SimpleToggle = () => {
  ...
  const isChecked = Boolean(userTheme === 'dark');
  ...
  return <MaterialUISwitch theme={theme} onClick={handleClick} checked={checked} />;
};
